...
################ CONFIGURATION ################
DATASET = Data.WHOLESALE
MODEL = Model.QUADRATIC_SVM_NO_REG
...
elif MODEL == Model.QUADRATIC_SVM_NO_REG:
    pipeline = Pipeline([
        ('scaler', StandardScaler()),
        ('quad_svm', QuadraticSvmClassifier(max_iters=1000, verbose=False, batch_size=128, alpha=0, lambda_=0))
    ])
